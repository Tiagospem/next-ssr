...
class _document_MyDocument extends document_default.a {
  ...
  render() {
    return __jsx("html", null, __jsx(next_document["Head"], null, __jsx("style", null, this.props.styleTags)), __jsx("body", null, __jsx(next_document["Main"], null), __jsx(next_document["NextScript"], null)));
  }
